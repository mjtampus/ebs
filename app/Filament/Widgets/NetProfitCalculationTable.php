...
class NetProfitCalculationTable extends BaseWidget
{
    ...
    public function table(Tables\Table $table): Tables\Table
    {
        ...
        return $table
            ->query($transactions)
            ->columns([
                Tables\Columns\TextColumn::make('timeframe')->label('Date'),
                Tables\Columns\TextColumn::make('revenue')->label('Revenue')->money('php'),
                Tables\Columns\TextColumn::make('expenses')
                    ->label('Expenses')
                    ->money('php')
                    ->getStateUsing(function ($record) {
                        return ExpenseList::whereDate('expense_date', $record->timeframe)->sum('total_amount');
                    }),
                Tables\Columns\TextColumn::make('net_profit')
                    ...
                    ->getStateUsing(function ($record) {
                        ...
                        $expenses = ExpenseList::whereDate('expense_date', $record->timeframe)->sum('total_amount');
